...
class MandelbrotDisplay {
    ...
    func generateMandelbrotSet() -> Void {
        ...
        mandelbrotSet = MandelbrotSetFactory.createMandelbrotSet(inZs: zs, inMaxIter: 200, inColorMap: Parula256().colorMapInSIMD4)
    ...
    private func setImage(for mandelbrotSet: MandelbrotSet?) -> Void {
        ...
        self.mandelbrotImage = NSImage(cgImage: mandelbrotSet.cgImage, size: NSSize.zero)
    }
